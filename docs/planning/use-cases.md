...
직원과 기사는 별도 계정보다 **사용자의 발주사별 소속과 역할**로 모델링하는 것을 제안한다. 다중 소속을 허용하므로 같은 사용자가 A사에서는 직원, B사에서는 기사일 수 있다. 직원 유형이 권한을 결정하는지는 아직 확인이 필요하다.
...
우선 결정할 항목은 **작업 상태, 비활성화 시 배정 처리**다. 추가로 다음 정책을 유즈케이스 계약에 명시해야 한다.
