...
| 총관리자 | 발주사·인력·유형 관리, 참여 요청 승인·거절, 회사 코드 관리, 총관리자 위임 | 조직당 총관리자 유지 조건, 탈퇴 제한 |
...
사무실의 인력 관리 화면은 `참여 인원`과 `승인 대기` 서브탭으로 나눈다. 참여 인원에서는 전체·사무실 직원·기사를 라디오로 구분해 조회한다. 같은 회사에서 한 회원은 직원 또는 기사 중 하나이며, 피그마 참여 인원의 역할 드롭다운과 달리 직원↔기사 역할 변경은 제공하지 않는다. 총관리자는 위임으로만 바뀐다. 승인 대기에서는 요청별 확정 유형을 고르고 개별 또는 선택 항목을 한 번에 승인·거절한다. 참여 요청 승인·거절은 총관리자만 할 수 있으며, 총관리자가 아닌 직원에게는 승인 대기 탭과 처리 버튼을 노출하지 않고 서버에서도 검증한다.
