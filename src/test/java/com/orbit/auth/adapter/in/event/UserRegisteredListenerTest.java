package com.orbit.auth.adapter.in.event;
...
import com.orbit.auth.application.port.in.command.RecordUserRegistrationUseCase;
import com.orbit.auth.application.port.in.command.dto.RecordUserRegistrationCommand;
import com.orbit.user.UserRegistered;
