 ...
 * 않은 요청이면 저장하지 않고 겹친 작업을 돌려준다. 서로 다른 작업을 같은 기사에게 동시에 잡는 경합은 아직 막지 않는다. 현재 담당기사가 여전히 조직의 활성
...
public class RescheduleWorkService implements RescheduleWorkUseCase {
    ...
    public RescheduleWorkService(LoadActorPort loadActorPort, WorkRepository workRepository, Clock clock) {
