 ...
 * 작업을 돌려준다. 서로 다른 작업을 같은 기사에게 동시에 잡는 경합은 아직 막지 않는다. 새 담당기사가 같은 조직의 활성 기사인지는 organization 계약이
...
public class ReassignWorkService implements ReassignWorkUseCase {
    ...
    public ReassignWorkService(LoadActorPort loadActorPort, WorkRepository workRepository, Clock clock) {
