...
public record ScheduleChangeInfo(boolean applied, List<ConflictingWork> conflicts) {
    ...
    public static ScheduleChangeInfo applied(List<ConflictingWork> conflicts) {
        return new ScheduleChangeInfo(true, conflicts);
    }

    public static ScheduleChangeInfo withheld(List<ConflictingWork> conflicts) {
        return new ScheduleChangeInfo(false, conflicts);
    }
